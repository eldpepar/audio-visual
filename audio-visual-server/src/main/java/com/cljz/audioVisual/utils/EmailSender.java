...
public class EmailSender {
    ...
    public static void sendRegisterVerifyCode(String verifyCode, String emailAddress) throws MessagingException {
        EmailSender.subject("光子影音管理系统注册验证码")
                .from("光子影音管理系统系统")
                .text("您的验证码为:" + verifyCode + "\n有效期为10分钟，若非本人操作，请忽略此邮件")
                .to(emailAddress)
                .send();
