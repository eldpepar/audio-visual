  ...
  <div v-if="show" class="list-box">
    <div class="category-list-box">
      <el-table
        ...
        <el-table-column prop="name" label="接口名称" width="240">
          <template slot-scope="scope">
             <span
        ...
        <el-table-column prop="user" label="添加人" width="248">
          <template slot-scope="scope">
           <span
      ...
      <div class="lables-dialog-box">
        ...
        <el-dialog :title="movieText" :visible.sync="editMusic" width="600px">
          <div class="lable-add_box">
            <el-form label-width="80px">
              ...
              <el-form-item label="添加人">
                <el-input v-model="musicItems.user" @input="change($event)" ></el-input>
              </el-form-item>
            </el-form>
          </div>
...
export default {
  ...
  methods: {
    ...
    editItem: function () {
        console.log("执行的编辑方法");
        this.$axios
            .put("/admin/music-update" + "?id=" + this.musicId, {
